...
public class MysqlBackup {  
    ...
    public static void backup(String path) throws IOException{  
        ...
        Process process = runtime.exec("mysqldump -uroot -p199612 --routines --events --triggers  book");  
    ...
    public static void recover(String path) throws IOException{  
        ...
        Process process = runtime.exec("mysql -uroot -p199612 --default-character-set=utf8  book");  
